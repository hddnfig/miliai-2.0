...
- 실사 인물·사물 이미지는 사용하지 않는다. 1차 디자인은 구조·타이포·컴포넌트·상태에 집중하고, 추상/키네틱 그래픽 고도화는 전체 화면 구조 확정 뒤 마지막 단계에서 일괄 진행한다.
...
- [ ] **VOD-02 · VOD 상세 · P0** — `예정` — 산출물: `/screens/VOD-02.html`
- [ ] **VOD-03 · 수강 신청 결과 · P0** — `예정` — 산출물: `/screens/VOD-03.html`
- [ ] **VOD-04 · VOD 플레이어 · P0** — `예정` — 산출물: `/screens/VOD-04.html`
- [ ] **VOD-05 · 퀴즈 · P0** — `예정` — 산출물: `/screens/VOD-05.html`
- [ ] **VOD-06 · 코딩 실습 · P0** — `예정` — 산출물: `/screens/VOD-06.html`
- [ ] **VOD-07 · 설문 · P1** — `예정` — 산출물: `/screens/VOD-07.html`
- [ ] **VOD-08 · 과정 완료 · P0** — `예정` — 산출물: `/screens/VOD-08.html`
...
70개 화면의 구조와 공용 컴포넌트가 안정화된 뒤 일괄 수행한다.

- [ ] 추상 모션/키네틱 그래픽 원리 정의
- [ ] 선·형·면 기반 배경 패턴 자산 세트
- [ ] 정적·호버·전환 상태의 모션 토큰
- [ ] 페이지군별 그래픽 밀도 규칙
